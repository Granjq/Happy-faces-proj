...
import { Star, ShoppingBag, Truck, ShieldCheck, Sun } from "lucide-react";
                        ...
                        <div className="p-8 md:p-10 flex flex-col h-full bg-white">
                            <DialogHeader>
                                <div className="flex items-center gap-2 text-primary text-xs font-bold tracking-widest uppercase mb-3">
                                    ...
                                    <span className="font-display text-xs font-bold tracking-widest uppercase">Best for: Summer & Daily Travel</span>
                                </div>
                                <DialogTitle className="font-display text-3xl md:text-4xl text-charcoal mb-2">
                                    {product.name}
                                </DialogTitle>
                                <DialogDescription className="text-muted-foreground mt-2">
                                    {product.intent || "Quick view of the selected product details and options."}
                                </DialogDescription>
                            </DialogHeader>
